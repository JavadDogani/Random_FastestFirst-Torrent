...
class Random_FastestFirst:
    ...
    def Random_FastestFirst_Execution(self,round_index,mydict):
        ...
        for i in range (nodes_Number):
            ...
            for chunk in missed_chunks:
                ...
                if len(chunk_owners)>0:
                    ...
                    Chunk_requests[random_sender].append((i,chunk,self.downlink_vector[i]))
                    #print(chunk_owners,random_sender)
    ...
    def Operation(self):
        ...
        while(Continue):
            ...
            Nodes_Number=len(self.neighborhood_matrix)
            chunks_matrix,partialtransmission=self.Random_FastestFirst_Execution(round_index,mydict)
